...
.selector {
  ...
  box-shadow: 0 0 5px rgba(80, 109, 118, 0.5), 0 0 5px rgba(80, 109, 118, 0.4),
    0 0 7px rgba(80, 109, 118, 0.3), 0 0 10px rgba(80, 109, 118, 0.2),
    0 0 15px rgba(80, 109, 118, 0.1);
  ...
  &-type {
    ...
    &-tag {
      padding: 10px;
      color: rgba(80, 109, 118, 1);
      border-bottom: 1px solid rgba(80, 109, 118, 0.7);
    }
    ...
    &-label {
      padding: 10px 15px;
      margin: 10px;
      box-shadow: 0 0 1px rgba(80, 109, 118, 0.5),
        0 0 2px rgba(80, 109, 118, 0.4), 0 0 3px rgba(80, 109, 118, 0.3),
        0 0 4px rgba(80, 109, 118, 0.2), 0 0 5px rgba(80, 109, 118, 0.1);
      transition: all ease 0.3s;
      cursor: pointer;
    }

    .selected {
      background-color: rgba(80, 109, 118, 0.8);
      color: white;
    }
  }
}
